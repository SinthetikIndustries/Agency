...
| `agent_list` | List all registered agents and their status |
| `agent_get` | Get full details of a specific agent |
| `agent_create` | Create a new agent (subject to agentManagementPermission) |
